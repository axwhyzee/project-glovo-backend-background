...
def extract_keywords(data: str, heading: str, top_n: int) -> list:
    model = KeyBERT()
    ...
    try:
        ...
        keywords = model.extract_keywords(data, stop_words="english", seed_keywords=heading_words, top_n=top_n,
